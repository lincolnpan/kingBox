...
public abstract class PullBaseView<T extends RecyclerView> extends LinearLayout {
    ...
    private void addHeaderView() {
        ...
        mHeaderProgressBar = (ProgressBar) mHeaderView.findViewById(R.id.xlistview_header_progressbar);
        mHeaderUpdateTextView.setText(getFormatDateString("MM-dd HH:mm"));
        // header layout
     ...
     */
    public void onFooterRefreshComplete(int postion) {
        setHeaderTopMargin(-mHeaderViewHeight);
        mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
        ...
        mFooterState = PULL_TO_REFRESH;
        /*if (mRecyclerView != null) {
            //mRecyclerView.scrollToPosition(mRecyclerView.getAdapter().getItemCount() - 1);  // 刷新到最后一条记录
